...
@file:JvmName("SegmentIdMatcherFactory")
...
@OptIn(InternalApi::class)
fun SegmentId.toSegmentIdMatcher(): SegmentIdMatcher = map { it.toLiteralStringMatcher() }.toSegmentIdMatcher()

fun SegmentIdMatcher(string: String): SegmentIdMatcher = string.toSegmentIdMatcher()
fun SegmentIdMatcher(matchers: List<StringMatcher>): SegmentIdMatcher = matchers.toSegmentIdMatcher()
fun SegmentIdMatcher(segmentId: SegmentId): SegmentIdMatcher = segmentId.toSegmentIdMatcher()
