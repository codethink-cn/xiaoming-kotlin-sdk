...
class LocalPluginManagerTest {
    ...
    fun testSimpleSolution(): Unit = runBlocking {
        val mcPlugin = pluginManager.registerInstalledPlugin(TestPluginConstants.mc100, configuration, TestPluginHandler, operation)
        val mcChatPlugin = pluginManager.registerInstalledPlugin(TestPluginConstants.mcChat100, configuration, TestPluginHandler, operation)
        val mcProPlugin = pluginManager.registerInstalledPlugin(TestPluginConstants.mcPro100, configuration, TestPluginHandler, operation)
    ...
    fun testMultiVersionLackDependencySolution(): Unit = runBlocking {
        val mc100 = pluginManager.registerInstalledPlugin(TestPluginConstants.mc100, configuration, TestPluginHandler, operation)
        val mc200 = pluginManager.registerInstalledPlugin(TestPluginConstants.mc200, configuration, TestPluginHandler, operation)
        val mcChat100 = pluginManager.registerInstalledPlugin(TestPluginConstants.mcChat100, configuration, TestPluginHandler, operation)

        // mc-chat:2.0.0 需要 im 插件，但是没有安装，所以哪怕它版本再高，也只能用 mc-chat:1.0.0
        val mcChat200 = pluginManager.registerInstalledPlugin(TestPluginConstants.mcChat200, configuration, TestPluginHandler, operation)
    ...
    fun testMultiVersionHighProvisionFirstSolution(): Unit = runBlocking {
        ...
        val mcPro100 = pluginManager.registerInstalledPlugin(TestPluginConstants.mcPro100, configuration, TestPluginHandler, operation)
        val mcChat100 = pluginManager.registerInstalledPlugin(TestPluginConstants.mcChat100, configuration, TestPluginHandler, operation)
        val mcChat200 = pluginManager.registerInstalledPlugin(TestPluginConstants.mcChat200, configuration, TestPluginHandler, operation)
        val im100 = pluginManager.registerInstalledPlugin(TestPluginConstants.im100, configuration, TestPluginHandler, operation)
        val imPro100 = pluginManager.registerInstalledPlugin(TestPluginConstants.imPro100, configuration, TestPluginHandler, operation)
    ...
    fun testIndirectDependencySolution(): Unit = runBlocking {
        ...
        val cmi100 = pluginManager.registerInstalledPlugin(TestPluginConstants.cmi100, configurationRetainOnConflict, TestPluginHandler, operation)
        ...
        val cmi200 = pluginManager.registerInstalledPlugin(TestPluginConstants.cmi200, configuration, TestPluginHandler, operation)
    ...
    fun testRelease(): Unit = runBlocking {
        ...
        assertEquals(null, pluginManager.getInstalledPlugins(TestPluginConstants.mc100.signature))
    }
