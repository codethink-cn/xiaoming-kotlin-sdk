...
interface KotlinPluginContext : LocalJvmClassicPluginContext, CoroutineScope {
    val logger: KLogger
}
...
interface KotlinPluginMain {
     ...
     * or set [KotlinPluginContext.error] to a non-null value to mark the
     * plugin as errored.
     *
     ...
     */
    fun onLoad(context: KotlinPluginContext) = Unit
     ...
     * @param context the context of this plugin.
     */
    fun onEnable(context: KotlinPluginContext) = Unit
     ...
     * @param context the context of this plugin.
     */
    fun onDisable(context: KotlinPluginContext) = Unit
}

object EmptyKotlinPluginMain : KotlinPluginMain