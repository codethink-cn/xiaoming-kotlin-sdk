...
value class TemplateImpl(
    private val format: String
) : Template {

    override fun format(mapper: (String) -> String): String {
        return StringSubstitutor { mapper(it) }.replace(format)
    }
...
object TemplateDeserializer : StdDeserializer<Template>(Template::class.java) {
    ...
    override fun deserialize(parser: JsonParser, context: DeserializationContext): Template {
        return TemplateImpl(parser.valueAsString)
    }
}