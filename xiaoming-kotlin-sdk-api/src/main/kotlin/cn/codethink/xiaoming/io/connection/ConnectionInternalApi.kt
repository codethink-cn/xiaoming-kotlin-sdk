 ...
 */
sealed interface ConnectionInternalApi<T> : AutoClosableSubject, CoroutineScope, AutoCloseable {
    /**
    ...
    override fun close() = close(TextCause("Connection internal API closed.", descriptor))
