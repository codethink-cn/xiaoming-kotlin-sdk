...
const val REQUEST_MODE_ASYNC_RESP = "async-resp"
...
const val CAUSE_TYPE_TEMPLATE = "template"
const val TEMPLATE_CAUSE_FIELD_KEY = "key"
const val TEMPLATE_CAUSE_FIELD_MESSAGE = "message"
const val TEMPLATE_CAUSE_FIELD_ARGUMENTS = "arguments"

const val CAUSE_TYPE_PACKET_DATA = "packet-data"
const val CAUSE_TYPE_PACKET_ID = "packet-id"
const val PACKET_DATA_CAUSE_FIELD_PACKET = "packet"
const val PACKET_CAUSE_FIELD_ID = "id"

const val VERSION_MAJOR_FIELD = "major"
const val VERSION_MINOR_FIELD = "minor"
const val VERSION_PATCH_FIELD = "patch"
const val VERSION_PRE_RELEASE_FIELD = "pre_release"
const val VERSION_BUILD_FIELD = "build"

const val MESSAGE_FIELD_KEY = "key"
const val MESSAGE_FIELD_VALUE = "value"
